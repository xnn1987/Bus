 ...
 * History:
 */
public class Disk extends RelativeLayout {
	...
	public Disk(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setBackID(int backID) {
		this.backID = backID;
		back = (DiskBack) findViewById(backID);
	}
