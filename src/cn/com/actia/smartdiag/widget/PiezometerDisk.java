 ...
 * History:
 */
public class PiezometerDisk extends RelativeLayout {
	...
	private View hand;
	private PiezometerBack back;

	private int backID;
	private int handID;
	private RotateListen rotaListen;

	public PiezometerDisk(Context context) {
		this(context, null);

	}

	public PiezometerDisk(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public PiezometerDisk(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setBackID(int backID) {
		this.backID = backID;
		back = (PiezometerBack) findViewById(backID);
	}
